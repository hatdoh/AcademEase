        ...
        <div className="ml-80 p-4">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button onClick={() => openModal()} className='w-40 h-9 text-center shadow-sm py-2 rounded-md bg-blue-500 font-medium text-2xl text-white hover:bg-blue-700 focus:outline-none focus:ring-1 focus:ring-offset-2 focus:ring-blue-500 sm:text-sm top-4 right-4'>
                        Create SF2
                    </button>
                </div>
            </div>
